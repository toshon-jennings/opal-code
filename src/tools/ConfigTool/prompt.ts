...
export const DESCRIPTION = 'Get or set OpalCode configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set OpalCode configuration settings.

  View or change OpalCode settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.opalcode.json)
${globalSettings.join('\n')}
