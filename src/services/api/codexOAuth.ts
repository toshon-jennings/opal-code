...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to OpalCode now.</p>
    <p>OpalCode will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in OpalCode.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in OpalCode.</p>
  </body>
</html>`
}
