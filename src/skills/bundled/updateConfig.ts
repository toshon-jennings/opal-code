...
Hooks run commands at specific points in OpalCode's lifecycle.
...
Modify OpalCode configuration by updating settings.json files.
...
6. **Use --debug** - Run \`opalcode --debug\` to see hook execution logs
`
