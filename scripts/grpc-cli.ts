...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/opalcode.proto')
...
async function main() {
  ...
  const client = new opalcodeProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mOpalCode gRPC CLI\x1b[0m')
